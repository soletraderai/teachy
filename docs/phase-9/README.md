...
### 1. `phase-9-feedback.md` - Feedback Collection
...
### 2. `phase-9-implementation-plan.md` - Implementation Strategy
...
1. Read `phase-9-feedback.md` thoroughly
...
### 3. `phase-9-tasks.md` - Actionable Task List
...
- Grouped by sub-phase (e.g., Phase 9.1, 9.2, 9.3)
...
1. Read `phase-9-implementation-plan.md` thoroughly
...
```
User reviews application → Documents issues/requests in phase-9-feedback.md
```

### Step 2: Implementation Planning
```
Agent reads feedback.md → Creates phase-9-implementation-plan.md → User approves
```

### Step 3: Task Breakdown
```
Agent reads implementation-plan.md → Creates phase-9-tasks.md → User approves
```

### Step 4: Execution & Documentation
```
Agent executes tasks → Updates SESSION-NOTES.md after each sub-phase
→ Marks tasks complete in phase-9-tasks.md
...
1. **Copy** this entire `phase-9` directory
2. **Rename** the folder to your phase number (e.g., `phase-10`)
3. **Rename** all files to match:
   - `phase-10-feedback.md`
